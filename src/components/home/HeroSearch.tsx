...
import heroDesktopAsset from "@/assets/hero-companion-samarkand-v2.jpg.asset.json";
import heroMobileAsset from "@/assets/hero-companion-samarkand-v2-mobile.jpg.asset.json";
