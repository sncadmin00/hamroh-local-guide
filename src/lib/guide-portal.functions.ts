...
const upsertTourSchema = z.object({
  ...
  highlights: z.array(z.string().trim().min(1).max(1000)).max(30).default([]),
  included: z.array(z.string().trim().min(1).max(1000)).max(30).default([]),
  not_included: z.array(z.string().trim().min(1).max(1000)).max(30).default([]),
