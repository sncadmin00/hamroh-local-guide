  ...
  terms: {
    en: {
      ...
      sections: [
        ...
        ["8. Contact", "Questions? Reach us at admin@supernovacarriers.com."],
      ],
    },
    ru: {
      ...
      sections: [
        ...
        ["8. Контакт", "Вопросы? Пишите на admin@supernovacarriers.com."],
      ],
    },
    uz: {
      ...
      sections: [
        ...
        ["8. Aloqa", "Savollar? admin@supernovacarriers.com ga yozing."],
      ],
    },
  },
  privacy: {
    en: {
      ...
      sections: [
        ...
        ["5. Your rights", "Request export or deletion of your data at admin@supernovacarriers.com."],
        ["6. Cookies", "We use essential cookies for login and minimal analytics."],
        ["7. Contact", "admin@supernovacarriers.com"],
    ...
    ru: {
      ...
      sections: [
        ...
        ["5. Ваши права", "Запросите экспорт или удаление данных на admin@supernovacarriers.com."],
        ["6. Cookies", "Используем необходимые cookies для входа и минимальной аналитики."],
        ["7. Контакт", "admin@supernovacarriers.com"],
    ...
    uz: {
      ...
      sections: [
        ...
        ["5. Sizning huquqlaringiz", "Ma'lumotlarni eksport yoki o'chirish uchun admin@supernovacarriers.com ga yozing."],
        ["6. Cookies", "Faqat kerakli cookies ishlatamiz."],
        ["7. Aloqa", "admin@supernovacarriers.com"],
  ...
  refund: {
    en: {
      ...
      sections: [
        ...
        ["How to request", "Use the 'Cancel' button in your bookings or write to admin@supernovacarriers.com."],
      ],
    },
    ru: {
      ...
      sections: [
        ...
        ["Как запросить", "Кнопка «Отменить» в ваших бронированиях или письмо на admin@supernovacarriers.com."],
      ],
    },
    uz: {
      ...
      sections: [
        ...
        ["Qanday so'rash", "Bronlaringizdagi «Bekor qilish» tugmasi yoki admin@supernovacarriers.com."],
      ],
    },
  },
} as const;
