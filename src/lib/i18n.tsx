...
export const translations: Dict = {
 ...
 "nav.myAccount": { en: "My account", uz: "Mening hisobim", ru: "Личный кабинет" },
 "nav.myBookings": { en: "My bookings", uz: "Bronlarim", ru: "Мои бронирования" },
 ...
 "spot.sectionEyebrow": { en: "Editors' pick", uz: "Tahririyat tanlovi", ru: "Выбор редакции" },
 ...
 "topTours.all": { en: "All", uz: "Hammasi", ru: "Все" },
  ...
  "banner.bookTour.label": { en: "Find your trip", uz: "Sayohatingizni toping", ru: "Найдите свою поездку" },
  "banner.bookTour.title": { en: "Book a tour", uz: "Tur bron qilish", ru: "Забронировать тур" },
  "banner.bookTour.subtitle": { en: "Search verified guides and tours by city, date and language.", uz: "Shahar, sana va til bo'yicha tasdiqlangan hamrohlar va sayohatlarni qidiring.", ru: "Ищите проверенных гидов и туры по городу, дате и языку." },
  ...
  "bg.tax.label": { en: "Tax ID (TIN) — optional", uz: "STIR (INN) — ixtiyoriy", ru: "ИНН — для самозанятых (необязательно)" },
  "bg.tax.hint": { en: "If you are registered as self-employed, please provide your Tax Identification Number.", uz: "Agar siz o'zini-o'zi band qiluvchi sifatida ro'yxatdan o'tgan bo'lsangiz, STIR raqamingizni kiriting.", ru: "Если вы зарегистрированы как самозанятый, укажите ваш ИНН." },
  "bg.tax.ph": { en: "e.g. 12345678901234", uz: "masalan, 12345678901234", ru: "например, 12345678901234" },
