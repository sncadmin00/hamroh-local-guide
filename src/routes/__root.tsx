...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book verified local guides in Tashkent, Samarkand, and Bukhara. Authentic experiences, multiple languages, instant booking." },
      { property: "og:title", content: "Hamroh — Trusted local guides in Uzbekistan" },
      { property: "og:description", content: "Book verified local guides in Tashkent, Samarkand, and Bukhara." },
