      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-3xl bg-card p-8 ring-1 ring-border/60 shadow-[var(--shadow-elegant)]">
          ...
          <button
            onClick={google}
            type="button"
            className="mt-6 w-full inline-flex h-11 items-center justify-center gap-2 rounded-full border border-input bg-background text-sm font-medium hover:bg-secondary transition-colors"
          >
